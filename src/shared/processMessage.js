...
function Process(textUser, number)
{
    ...
    {
        var model = whatsappModel.MessageText("Un sabroso plato, te recomiendo el siguiente video donde podras encontrar mas informacion sobre los platos de conejo: https://www.youtube.com/watch?v=ZmrRYeHI-3o", number);
        models.push(model)
    } 
